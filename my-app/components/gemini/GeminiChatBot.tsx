...
export default function GeminiChatBot({ open, onOpenChange }: GeminiChatBotProps) {
    ...
    <>
      {mounted && createPortal(
        <>
          ...
          {!isOpen && (
            <div className="fixed left-6 top-1/2 transform -translate-y-1/2 z-[999999]">
              <button
          ...
          <div className={`fixed left-0 top-0 h-full z-[999999] transition-transform duration-500 ease-in-out ${
